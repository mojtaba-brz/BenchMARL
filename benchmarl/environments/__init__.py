...
from .gridworld.common import GridWorldCPPTask
from .game_theory_game.common import TwoPlayerGameTheoryClass, TwoPlayerGameTheoryTask
...
tasks = [VmasTask, Smacv2Task, PettingZooTask, MeltingPotTask, MAgentTask, GridWorldCPPTask, TwoPlayerGameTheoryTask]
